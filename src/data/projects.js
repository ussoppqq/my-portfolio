export const projects = [
  {
    ...
    category: 'ai',
    description: {
      id: 'Vehiscan adalah sistem bertenaga AI yang mendeteksi dan menghitung kendaraan secara real-time serta mengenali plat nomor. Dibuat dengan YOLOv8 dan Flet, sistem ini terintegrasi dengan Roboflow untuk pelatihan model, AWS S3 untuk penyimpanan cloud, dan Notion untuk pencatatan data.',
  ...
  },
  {
    ...
    category: 'web',
    description: {
      id: 'asgartStudio adalah website responsif yang saya buat untuk studio fotografi, menampilkan galeri foto, deskripsi layanan, dan formulir pemesanan yang terintegrasi melalui email. Dibangun menggunakan React, Vite, dan Tailwind CSS untuk kinerja cepat dan tampilan bersih di semua perangkat.',
  ...
  },
  {
    ...
    category: 'ai',
    description: {
      id: 'Chatbot pintar yang dibangun untuk menjawab pertanyaan tentang sejarah Indonesia menggunakan Flask, BERT, dan all-MiniLM-L6-v2. Sistem ini menggunakan Hugging Face Transformers untuk pencarian semantik dan ekstraksi jawaban.',
  ...
  },
  {
    ...
    category: 'ai',
    description: {
      id: 'Proyek deep learning menggunakan model U-Net kustom di TensorFlow untuk segmentasi tumor otak dari scan MRI grayscale. Menyediakan pipeline lengkap dari preprocessing, pelatihan, hingga visualisasi hasil.',
  ...
  },
  {
    ...
    category: 'ai',
    description: {
      id: 'Aplikasi pengeditan gambar interaktif menggunakan Python, Flet, dan OpenCV. Pengguna dapat mengatur kecerahan, kontras, menerapkan filter, memotong, memutar, dan mengunduh gambar dengan antarmuka yang ramah pengguna.',
  ...
  },
  {
    ...
    category: 'mobile',
    description: {
      id: 'E-Laundry adalah platform mobile dan web untuk mencari serta mengelola layanan laundry terdekat. Aplikasi mobile memungkinkan pengguna memesan, menjadwalkan antar/jemput, dan membayar via QRIS. Admin dapat mengelola pesanan melalui dashboard web.',
  ...
  },
  {
    ...
    category: 'web',
    description: {
      id: 'PresMUN adalah website event responsif untuk konferensi Model United Nations, dibangun dengan React, Vite, dan Tailwind CSS. Menyediakan informasi acara, profil pembicara, form pendaftaran online, dan kontak.',
  ...
  },
  {
    ...
    category: 'mobile',
    description: {
      id: 'PUNTEN adalah web app mobile-friendly berbasis PHP untuk mempermudah pemesanan makanan di kantin President University. Pengguna dapat melihat kantin, memesan, melacak status pesanan, mengelola akun, dan memberikan ulasan.',
