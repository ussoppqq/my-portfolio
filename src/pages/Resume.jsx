...
import { Download, GraduationCap, Code, Award, ExternalLink } from "lucide-react";
        ...
        <div className="min-h-screen pt-20 bg-gray-50 dark:bg-gray-900">
            ...
            <section className="py-20 px-4 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        Discover my professional journey, skills, and achievements
                    </motion.p>
            ...
            <div className="max-w-4xl mx-auto px-4 pb-20">
                ...
                >
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-12 text-lg">
                        Discover the tools and technologies I use to create websites & applications.
                    </p>
